...
$sql = "
    ...
    WHERE
        ...
        OR Ventas_POS.Identificador_tipo = "00000000002" 
        OR Ventas_POS.Identificador_tipo = "00000000003"
        OR Ventas_POS.Identificador_tipo = "00000000004"
        OR Ventas_POS.Identificador_tipo = "00000000005"
    GROUP BY
        Ventas_POS.Folio_Ticket
    ORDER BY
