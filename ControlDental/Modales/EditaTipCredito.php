...
<div class="form-group">
  ...
  <input type="text" class="form-control " disabled readonly value="<?php echo $Especialistas->ID_Tip_Cred; ?>">
    </div>
    </div>
  ...
  <input type="text" class="form-control "  name="ActCrediNom" id="actcredinom" value="<?php echo $Especialistas->Nombre_Tip; ?>" aria-describedby="basic-addon1" maxlength="60">            
</div></div></div>
...
<div class="form-group">
  ...
  <input type="text" class="form-control "  name="ActCosto" id="actcosto" value="<?php echo $Especialistas->Costo; ?>" aria-describedby="basic-addon1" maxlength="60">            
</div></div></div>
