...
<script>
  $(document).ready(function() {
    ...
    $(document).on("click", ".btn-desglose", function() {
        var id = $(this).data("id");
        $.post("https://saludapos.com/ControlDental/Modales/DesgloseTicketCreditoEnfermeria.php", { id: id }, function(data) {
    ...
    $(document).on("click", ".btn-Reimpresion", function() {
        var id = $(this).data("id");
        $.post("https://saludapos.com/ControlDental/Modales/ReimpresionTicketVentaCreditoEnfermeria.php", { id: id }, function(data) {
            $("#FormCancelacion").html(data);
