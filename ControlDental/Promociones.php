...
<head>
    ...
    <title>Promociones Crédito | <?= $row['ID_H_O_D'] ?></title>
...
<div class="container mt-3">
    <div class="tab-pane fade show active" id="pills-TipPro" role="tabpanel" aria-labelledby="pills-home-tab">
        <div class="card">
            ...
            <div class="card-body">
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#AltaPromosCreditos">
                    Añadir nueva promoción <i class="fas fa-plus-square"></i>
                </button>
