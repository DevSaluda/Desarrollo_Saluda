...
$(".btn-Detalles").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/DetallesStockSucursales.php","id="+id,function(data){
  	...
  	$(".btn-editStock").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/ActualizaDataStock.php","id="+id,function(data){
  			$("#form-editStockSucursalesA").html(data);
    ...
    $(".btn-HistorialStocksucursaless").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/HistorialStockSucursales.php","id="+id,function(data){
  			$("#form-editStockSucursalesA").html(data);
