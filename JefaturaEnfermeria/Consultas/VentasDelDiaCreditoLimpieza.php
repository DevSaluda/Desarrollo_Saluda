...
tabla = $('#ProductosLimpieza').DataTable({
 ...
 "bAutoWidth": true,
 "order": [[ 0, "desc" ]],
 "sAjaxSource": "https://controlfarmacia.com/JefaturaEnfermeria/Consultas/ArrayDesgloseVentasCreditoLimpieza.php",
 "aoColumns": [
       { mData: 'Cod_Barra' },
       { mData: 'Nombre_Prod' },
       { mData: 'FolioTicket' },
...
<div class="text-center">
    ...
    <table  id="ProductosLimpieza" class="table table-hover">
<thead>
