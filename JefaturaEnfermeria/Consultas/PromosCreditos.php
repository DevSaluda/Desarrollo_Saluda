...
<script>
  	$(".btn-editPromos").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/EditaPromo.php","id="+id,function(data){
    ...
    $(".btn-HistorialPromos").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/HistorialPromosCreditos.php","id="+id,function(data){
              $("#EditPromos").html(data);
