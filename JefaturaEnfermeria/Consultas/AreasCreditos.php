...
<script>
  	$(".btn-editArea").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/EditaAreaCredito.php","id="+id,function(data){
  			$("#EditAreas").html(data);
    ...
    $(".btn-HistorialAreas").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/HistorialAreasCreditos.php","id="+id,function(data){
              $("#EditAreas").html(data);
