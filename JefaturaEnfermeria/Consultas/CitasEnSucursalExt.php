...
<script>
  ...
  var mensajesCarga = [
    ...
    "✍️ Cada cita es una firma de tu compromiso con el éxito.",
    "📌 Agendando momentos que importan, uno tras otro.",
    "🧩 Las citas son piezas del rompecabezas de tus días productivos."
  ];
  ...
  // Iniciar la tabla DataTable
  var tabla = $('#CitasExpress').DataTable({
    "bProcessing": true,
    "ordering": true,
    "stateSave": true,
    "bAutoWidth": false,
    "order": [[0, "desc"]],
    "sAjaxSource": "https://saludapos.com/JefaturaEnfermeria/Consultas/ArrayAgendaEspecialidades.php",
    "aoColumns": [
      { mData: 'Folio' },
      { mData: 'Paciente' },
      { mData: 'Telefono' },
