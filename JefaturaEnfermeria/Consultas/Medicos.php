...
<script>
  	$(".btn-edit").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/ContactoMedico.php","id="+id,function(data){
  			$("#form-edit").html(data);
    ...
    $(".btn-edit2").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/EditaMedico.php","id="+id,function(data){
              $("#form-edit").html(data);
    ...
    $(".btn-HistorialEmpleados").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/HistorialMedicos.php","id="+id,function(data){
              $("#form-edit").html(data);
    ...
    $(".btn-BajaDeEmpleados").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/BajaDeMedicos.php","id="+id,function(data){
              $("#form-edit").html(data);
