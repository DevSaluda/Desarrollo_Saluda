...
Personal_Intendecia.Fk_Sucursal= SucursalesCorre.ID_SucursalC   AND Personal_Intendecia.Estatus='Vigente' AND Personal_Intendecia.ID_H_O_D='".$row['ID_H_O_D']."'";
...
<a data-id="<?php echo $Especialidades["Intendencia_ID"];?>" class="btn-edit2 dropdown-item" >Editar datos <i class="fas fa-pencil-alt"></i></a>
  <a data-id="<?php echo $Especialidades["Intendencia_ID"];?>" class="btn-BajaDeEmpleados dropdown-item" >Marcar como baja <i class="fas fa-user-slash"></i></a>
</div>
<!-- Basic dropdown -->
   </td>
...
<script>
    ...
    $(".btn-edit2").click(function(){
      id = $(this).data("id");
      $.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/EditaIntendentes.php","id="+id,function(data){
              $("#form-edit").html(data);
    ...
    $(".btn-BajaDeEmpleados").click(function(){
      id = $(this).data("id");
      $.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/BajaDeIntendes.php","id="+id,function(data){
              $("#form-edit").html(data);
