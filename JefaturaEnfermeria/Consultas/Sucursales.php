...
<?php endif;?>
  ...
  <script>
    ...
    $(".btn-edit2").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludapos.com/JefaturaEnfermeria/Modales/EditaSucursal.php","id="+id,function(data){
              $("#form-edit").html(data);
    ...
    $(".btn-Historial").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludapos.com/JefaturaEnfermeria/Modales/HistorialSucursales.php","id="+id,function(data){
              $("#form-edit").html(data);
