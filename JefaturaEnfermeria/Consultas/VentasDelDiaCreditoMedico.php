...
tabla = $('#ProductosMedico').DataTable({
 ...
 "bAutoWidth": true,
 "order": [[ 0, "desc" ]],
 "sAjaxSource": "https://controlfarmacia.com/JefaturaEnfermeria/Consultas/ArrayDesgloseVentasCreditoMedico.php",
 "aoColumns": [
       { mData: 'Cod_Barra' },
       { mData: 'Nombre_Prod' },
       { mData: 'FolioTicket' },
...
<div class="text-center">
    ...
    <table  id="ProductosMedico" class="table table-hover">
<thead>
