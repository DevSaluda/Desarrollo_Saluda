...
<script>
  	$(".btn-editServ").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/EditaServicio.php","id="+id,function(data){
  			$("#form-Serv").html(data);
    ...
    $(".btn-editServ2").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/DetallesServicio.php","id="+id,function(data){
              $("#form-Serv").html(data);
    ...
    $(".btn-historialServ").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/HistorialServicio.php","id="+id,function(data){
              $("#form-Serv").html(data);
