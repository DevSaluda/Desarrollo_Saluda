...
tabla = $('#ProductosFarmaceutico').DataTable({
 ...
 "bAutoWidth": true,
 "order": [[ 0, "desc" ]],
 "sAjaxSource": "https://controlfarmacia.com/JefaturaEnfermeria/Consultas/ArrayDesgloseVentasCreditoFarmaceutico.php",
 "aoColumns": [
       { mData: 'Cod_Barra' },
       { mData: 'Nombre_Prod' },
       { mData: 'FolioTicket' },
...
<div class="text-center">
    ...
    <table  id="ProductosFarmaceutico" class="table table-hover">
<thead>
