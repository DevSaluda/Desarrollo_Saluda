...
<script>
  	$(".btn-editMedico").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/EditaMedCredito.php","id="+id,function(data){
    ...
    $(".btn-HistorialMedicos").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/HistorialMedicosCreditos.php","id="+id,function(data){
              $("#EditMedicos").html(data);
