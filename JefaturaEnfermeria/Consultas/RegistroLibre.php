...
SucursalesCorre.ID_SucursalC,SucursalesCorre.Nombre_Sucursal FROM Signos_VitalesV2,SucursalesCorre  WHERE Signos_VitalesV2.Fk_Sucursal=SucursalesCorre.ID_SucursalC GROUP BY Signos_VitalesV2.ID_SignoV DESC";  
...
<?php endif;?>
  ...
  <script>
  	$(".btn-edit").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludapos.com/JefaturaEnfermeria/Modales/ConfirmaDatosP.php","id="+id,function(data){
  			$("#form-edit").html(data);
  		});
