...
while($fila=$result->fetch_assoc()){
    ...
    $data[$c]["Acciones"] = ["<a href=https://saludapos.com/JefaturaEnfermeria/ActualizaInventarios?idProd=".base64_encode($fila["Folio_Prod_Stock"])." type='button' class='btn btn-success  btn-sm '><i class='fas fa-sliders-h'></i></a> "];
