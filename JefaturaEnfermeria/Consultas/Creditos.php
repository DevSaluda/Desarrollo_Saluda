...
<script>
  	$(".btn-edit").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/AbonoCredito.php","id="+id,function(data){
  			$("#form-edit").html(data);
    ...
    $(".btn-edit2").click(function(){
  		id = $(this).data("id");
  		$.post("https://controlfarmacia.com/JefaturaEnfermeria/Modales/HistorialSaldos.php","id="+id,function(data){
              $("#form-edit").html(data);
