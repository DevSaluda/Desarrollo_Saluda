...
as existencias,Ventas_POS.Importe,Ventas_POS.Cliente,Ventas_POS.FormaDePago,Ventas_POS.Fecha_venta,Ventas_POS.AgregadoPor,Ventas_POS.AgregadoEl,Ventas_POS.ID_H_O_D, SucursalesCorre.ID_SucursalC,SucursalesCorre.Nombre_Sucursal 
FROM SucursalesCorre, Ventas_POS Where FormaDePago ='Credito Enfermería' AND  SucursalesCorre.ID_SucursalC= Ventas_POS.Fk_sucursal GROUP by Ventas_POS.Nombre_Prod,Ventas_POS.Fk_sucursal";  
...
<tr>
    ...
    <td><?php echo $DataPacientes["Cliente"]; ?></td>
    <td><?php echo $DataPacientes["Fecha_venta"]; ?></td>
    <td><?php echo $DataPacientes["AgregadoEl"]; ?></td>
    <td><?php echo $DataPacientes["AgregadoPor"]; ?></td>
