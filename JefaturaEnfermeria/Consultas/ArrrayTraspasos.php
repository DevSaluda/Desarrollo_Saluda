...
while($fila=$result->fetch_assoc()){
   ...
   // Verificar si la columna "NumberFactura" está vacía
   if (empty($fila["Num_Factura"])) {
    ...
    $data[$c]["Traspasocorrecto"] = ["<a href=https://saludapos.com/JefaturaEnfermeria/TraspasoOKV2?traspasoid=".base64_encode($fila["ID_Traspaso_Generado"])." type='button' class='btn btn-success  btn-sm '><i class='fas fa-check'></i></a> "];
