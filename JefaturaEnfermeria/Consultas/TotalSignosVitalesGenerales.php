...
$user_id=null;
$sql1="SELECT Signos_VitalesV2.ID_SignoV,Signos_VitalesV2.Nombre_Doctor, COUNT(*) as totalsignosvitales,Signos_VitalesV2.Fk_Enfermero,Signos_VitalesV2.Fk_Sucursal,Signos_VitalesV2.FK_ID_H_O_D, Signos_VitalesV2.Fecha_Visita,Signos_VitalesV2.Estatus,Signos_VitalesV2.CodigoEstatus, SucursalesCorre.ID_SucursalC,SucursalesCorre.Nombre_Sucursal FROM Signos_VitalesV2,SucursalesCorre where  Signos_VitalesV2.Fk_Sucursal= SucursalesCorre.ID_SucursalC GROUP BY Signos_VitalesV2.Fk_Enfermero,Signos_VitalesV2.Fk_Sucursal DESC";  
...
<tr>
    ...
    <td><?php echo $DataPacientes["totalsignosvitales"]; ?></td>
