            ...
            <div class="text-center">
                ...
                <div class="modal-body">
                    ...
                    <form action="javascript:void(0)" method="post" id="AgregaTipoProductoNuevo">
                        ...
                        <input type="text" class="form-control " hidden  readonly id="usuariom" name="UsuarioTP"  readonly value="<?php echo $row['Nombre_Apellidos']?>">
                        <input type="text" class="form-control " hidden  readonly name="VigenciaEstPP" id="vigenciatipoprodd">
                        <input type="text" class="form-control " hidden  readonly id="sistemam" name="SistemaPP" readonly value="POS <?php echo $row['Nombre_rol']?>">
                        <input type="text" class="form-control " hidden id="empresam" name="EmpresaPP" readonly value="<?php echo $row['ID_H_O_D']?>">
                        <div>
