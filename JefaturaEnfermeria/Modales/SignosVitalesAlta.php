...
<div class="row">
  ...
  <input type="text" class="form-control" value="<? echo $datapacientes->Nombre_Paciente; ?>" name="Nombres" id="nombres" aria-describedby="basic-addon1">
</div>
    </div>
    </div>
    <div class="row">
  ...
  <input type="text" class="form-control" value="<? echo $datapacientes->Edad; ?>" name="Edad" id="edad" aria-describedby="basic-addon1">
</div>
    </div>
    <div class="col">
  ...
  <input type="text" class="form-control" value="<? echo $datapacientes->Sexo; ?>" name="Sexo" id="sexo" aria-describedby="basic-addon1">
</div>
    </div>
    </div>
    </div>
