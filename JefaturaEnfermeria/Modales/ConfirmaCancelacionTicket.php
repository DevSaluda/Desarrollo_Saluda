...
<div class="form-group">
  ...
  <input type="text" class="form-control " name="TicketFolioACancelar" readonly value="<?php echo $Especialistas->Folio_Ticket; ?>">
    </div>
    </div>
  ...
  <input type="Text" class="form-control " name="ActCantidad" id="actcantidad" value="<?php echo $Especialistas->Motivo_Cancelacion; ?>" aria-describedby="basic-addon1" >            
</div></div></div>
