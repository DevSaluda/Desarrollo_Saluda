...
<input type="text" class="form-control " hidden disabled readonly id="usuariom" disabled readonly value="<?php echo $row['Nombre_Apellidos']?>">
<input type="text"  class="form-control " hidden disabled readonly name="VigenciaEst" id="vigenciaestm">
<input type="text" class="form-control "  hidden disabled readonly id="sistemam" disabled readonly value="POS <?php echo $row['Nombre_rol']?>">
<input type="text" class="form-control "  hidden id="empresam" disabled readonly value="<?php echo $row['ID_H_O_D']?>">
  <div>
