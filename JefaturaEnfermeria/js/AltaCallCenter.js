...
vigencia: {
  required: true,        
    ...
    function submitForm() { 
      ...
      $("#AgregaCallCenter").on('submit', function(){    
    
    

        $.ajax({                
            type : 'POST',
            url  : 'https://controlfarmacia.com/JefaturaEnfermeria/Consultas/AltaCallCenter',
      ...
      success: function(dataResult){
        ...
        setTimeout(function(){ 
            $("#submit_registro").html("Guardar <i class='fas fa-save'></i>");
             ...
             $("#AgregaCallCenter")[0].reset();
             $("#AltaCallCenter").removeClass("in");
