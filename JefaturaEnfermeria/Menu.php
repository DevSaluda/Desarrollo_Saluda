...
?>">
  <li class="nav-header">Almacenaje y productos <i class="fas fa-dolly"></i></li>
...
?>">
    <li class="nav-header">Traspasos <i class="fas fa-truck-loading"></i></i></li>
    <li class="nav-item">
    ...
    <li class="nav-item has-treeview">
        <a href="#" class="nav-link">
            ...
            <p>Traspasos<i class="fas fa-angle-left right"></i></p>
        </a>
        <ul class="nav nav-treeview">
            <li class="nav-item">
                <a href="RegistroTraspasos" class="nav-link">
                    <i class="fas fa-dot-circle"></i>
                    <p>Registro Traspasos</p>
                </a>
            </li>
            <li class="nav-item">
...
<div style="<?php
    switch ($row['Permisos']) {
        ...
        case 0:
            ...
            break;
        default:
            echo ""; // Puedes manejar un caso por defecto si ninguno de los casos anteriores coincide
    }
?>">
    <li class="nav-item has-treeview">
        <a href="#" class="nav-link">
