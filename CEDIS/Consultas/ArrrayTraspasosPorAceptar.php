...
Traspasos_generados.Precio_Venta,Traspasos_generados.Precio_Compra, Traspasos_generados.Total_traspaso,Traspasos_generados.TotalVenta,Traspasos_generados.Existencias_R,
 ...
 Traspasos_generados.Fk_SucDestino=21"; 
...
while($fila=$result->fetch_assoc()){
    ...
    $data[$c]["Traspasocorrecto"] = ["<a href=https://controlfarmacia.com/CEDIS/TraspasoOK?traspasoid=".base64_encode($fila["ID_Traspaso_Generado"])." type='button' class='btn btn-success  btn-sm '><i class='fas fa-check-double'></i></a> "];
     $data[$c]["Traspasoincorrecto"] = ["<a href=https://controlfarmacia.com/CEDIS/ProblemaTraspaso?traspasoid=".base64_encode($fila["ID_Traspaso_Generado"])." type='button' class='btn btn-warning  btn-sm '><i class='fas fa-exclamation-triangle'></i></a> "];
