...
while($fila=$result->fetch_assoc()){
    ...
    $data[$c]["Fecha_Caducidad"] = $fila["Fecha_Caducidad"];
       $data[$c]["Acciones"] = ["<a href=https://controlfarmacia.com/CEDIS/ActualizaOne?idProd=".base64_encode($fila["Folio_Prod_Stock"])." type='button' class='btn btn-success  btn-sm '><i class='fas fa-check-double'></i></a> "];
    $c++; 
