...
<a type="button" class="btn btn-outline-success btn-sm" href="https://saludapos.com/AdminPOS/VerificaAsignacionProducto?idProd=<?php echo base64_encode($Especialistas->ID_Prod_POS); ?>" class="btn btn-default">
