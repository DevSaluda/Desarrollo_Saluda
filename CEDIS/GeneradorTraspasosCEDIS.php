...
function calcularDiferencia(fila) {
  ...
  if (row.length) {
    ...
    <td class="preciodecompra"><input class="form-control preciocompra-input" readonly style="font-size: 0.75rem !important;" name="PrecioCompra[]" value="${articulo.preciocompra}" /></td>
...
<td style="display:none;"><input type="text" name="SucursalDestinoFK[]" hidden value="<?php echo  $SucursalDestino; ?>" class="form-control" ></td>
    ...
    <td style="display:none;" ><input type="text" class="form-control " hidden name="TipoMov[]" readonly value="Traspaso de cedis" ></td>
    <td style="display:none;"><input type="text" class="form-control " name="NumeroDeFacturaTraspaso[]" readonly value="<?php echo ($ProveedorFijo === 'CEDIS') ? $valorCombinado : $NumeroDeFacturaTrapaso; ?>" ></td>
</tr>`;
...
<!-- ./wrapper -->
<script src="js/RealizaTraspasosDeCedis.js"></script>
