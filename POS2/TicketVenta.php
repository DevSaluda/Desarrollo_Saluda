<?php
    ...
    $pdf = new PDF_Code128('P','mm',array(58,210));
    ...
    $pdf->Image('https://controlfarmacia.com/POS2/Componentes/logoticketsv3.jpg', 10, 10, 60, 20);
    
    $pdf->MultiCell(0, 5, utf8_decode(strtoupper($row['Nombre_Apellidos'])), 0, 'C', false);
    $pdf->SetFont('Arial','',9);
    ...
    $pdf->Cell(32,5,utf8_decode("+ $70.00 "),0,0,'C');
    ...
    $pdf->Cell(32,5,utf8_decode("$100.00 "),0,0,'C');

    $pdf->Ln(5);

    $pdf->Cell(18,5,utf8_decode(""),0,0,'C');
    $pdf->Cell(22,5,utf8_decode("CAMBIO"),0,0,'C');
    $pdf->Cell(32,5,utf8_decode("$30.00 "),0,0,'C');
