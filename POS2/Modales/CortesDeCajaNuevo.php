...
<div class="col">
  ...
  <input type="number" class="form-control "  id="cantidadtotalventas" name="Cantidad" step="any" readonly value="<?php echo $Especialistas33->number_format($ventaTotalEfectivoRedondeado, 2); ?>" aria-describedby="basic-addon1" >  
</div></div>
<div class="col">
