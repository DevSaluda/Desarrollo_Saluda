...
<?php endif;?>
  ...
  <script>
    ...
    $(".btn-Cancela").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludapos.com/POS2/Modales/CancelaCitaLab.php","id="+id,function(data){
    ...
    $(".btn-Asiste").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludapos.com/POS2/Modales/AsistenciaPacienteLaboratorio.php","id="+id,function(data){
              $("#form-editExt").html(data);
