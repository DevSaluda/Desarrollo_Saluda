...
<thead>
  <th style="background-color:#0057b8 !important;">ID</th>
  <th style="background-color:#0057b8 !important;">Nombre componente</th>
	<th style="background-color:#0057b8 !important;">Accciones</th>
...
<?php endif;?>
  ...
  <script>
    ...
    $(".btn-edit2").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludapos.com/AdminPOS/Modales/EditaProveedor.php","id="+id,function(data){
              $("#form-edit").html(data);
    ...
    $(".btn-edit3").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludapos.com/AdminPOS/Modales/DetallesProveedor.php","id="+id,function(data){
              $("#form-edit").html(data);
    ...
    $(".btn-historial").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludapos.com/AdminPOS/Modales/HistorialProveedores.php","id="+id,function(data){
              $("#form-edit").html(data);
              $("#Titulo").html("Editar datos de empleado");
              $("#Di").removeClass("modal-dialog modal-lg modal-notify modal-info");
              $("#Di").removeClass("modal-dialog modal-lg modal-notify modal-danger");
