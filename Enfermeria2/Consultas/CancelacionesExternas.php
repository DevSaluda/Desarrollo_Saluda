...
tabla = $('#Cancelacionexteriror').DataTable({
 ...
 "bAutoWidth": false,
 "order": [[ 0, "desc" ]],
 "sAjaxSource": "https://saludapos.com/Enfermeria2/Consultas/arrayCancelacionExternas.php",
 "aoColumns": [
  { mData: 'Folio' },  
  { mData: 'Nombre' },
  { mData: 'Fecha' },
...
"responsive": true
  ...
  <div class="text-center">
	...
	<table  id="Cancelacionexteriror" class="table table-hover">
<thead>
<th>Folio</th>
<th>Paciente</th>
<th>Fecha</th>
...
<th>Observaciones</th>
  ...
  <script>
    ...
    $(".btn-Detalles").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludapos.com/AgendaDeCitas/Modales/DetallesCitaSucursalExt.php","id="+id,function(data){
