...
<div class="wrapper">
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-primary navbar-light" style="background-color: #CE009F !important;">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="index" class="brand-link" style="background-color: #CE009F !important;">
     ...
     <div class="sidebar" style ="background-color: #0057b8 !important;">
      ...
      <nav class="mt-2" style="color: white;">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
          <a href="<?php echo $row['Url_Drive_Enfermeria'] ?>" target="_blank" class="nav-link">
