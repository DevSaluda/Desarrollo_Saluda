...
<div class="text-center">
   ...
   <input type="text" name="SucursalDestino[]"   id="SucDestino" class="form-control" value="<?php echo $SucursalDestino?>">
   ...
   <input type="text" class="form-control "  hidden name="GeneradoPor[]" value="<?php echo $row['Nombre_Apellidos']?>"readonly  >
      ...
      <input type="text" class="form-control " hidden  name="ProveedorDelTraspaso[]" readonly  value="CEDIS"  >
