...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index" class="brand-link" style="background-color: #c80096 !important;">
      ...
      <span class="brand-text font-weight-light" style="color: white;">SALUDA CENTRO MEDICO FAMILIAR</span>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="https://saludapos.com/CEDISMOVIL/ProductosV2" class="nav-link">
...
window.location.replace('https://saludapos.com/CEDISMOVIL/Cierre'); 
