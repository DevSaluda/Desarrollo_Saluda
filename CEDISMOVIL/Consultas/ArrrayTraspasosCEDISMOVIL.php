...
while($fila=$result->fetch_assoc()){
   ...
   if (empty($fila["Num_Factura"])) {
    ...
    $data[$c]["Traspasocorrecto"] = ["<a href=https://saludapos.com/CEDISMOVIL/TraspasoOKV2?traspasoid=".base64_encode($fila["ID_Traspaso_Generado"])." type='button' class='btn btn-success  btn-sm '><i class='fas fa-check'></i></a> "];
