    ...
    <div class="modal-content">
      ...
      <div class="text-center">
        ...
        <div class="modal-body">
          ...
          <form method="POST" action="https://saludapos.com/CEDISMOVIL/Preresultadoparaimpresionescedis">
            <div class="row">
...
$(document).ready(function() {
    ...
    $('#sucursal').on('change', function() {
        ...
        if (sucursal) {
            $.ajax({
                url: 'https://saludapos.com/CEDISMOVIL/Consultas/obtener_resultados.php',
                type: 'POST',
