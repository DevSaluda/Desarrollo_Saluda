$('document').ready(function($) {
    ...
    $("#RegistroCombustibleForMulario").validate({
        rules: {
    ...
    function submitForm() {
        ...
        $("#RegistroCombustibleForMulario").on('submit', function() {



            $.ajax({
                type: 'POST',
                url: 'https://controlfarmacia.com/AdminPOS/Consultas/RegistroDeCombustibleDiario.php',
                ...
                success: function(dataResult) {
                    ...
                    if (dataResult.statusCode == 250) {
                        ...
                        $("#RegistroCombustibleForMulario")[0].reset();
                        $("#RegistroCombustibleVentanaModal").removeClass("in");
                        $(".modal-backdrop").remove();
                        $("#RegistroCombustibleVentanaModal").hide();
