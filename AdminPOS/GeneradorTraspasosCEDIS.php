...
function calcularDiferencia(fila) {
  ...
  if (row.length) {
    ...
    <td><input type="text" class="form-control " name="NumeroDeFacturaTraspaso[]" readonly value="<?php echo ($ProveedorFijo === 'CEDIS') ? $valorCombinado : $NumeroDeFacturaTrapaso; ?>" ></td>
</tr>`;
