...
<head>
  ...
  <title>Registro de energia <?php echo $row['ID_H_O_D']?> <?php echo $row['Nombre_Sucursal']?> </title>
        ...
        $(document).ready(function() {
          tabla = $('#Productos').DataTable({
            ...
            "ajax": {
              ...
              "url": "https://saludapos.com/AdminPOS/Consultas/ArrayEnergiaElectricaFiltros.php",
              "data": function (d) {
