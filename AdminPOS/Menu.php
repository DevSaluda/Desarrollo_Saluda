...
?>>   
        ...
        Clientes
          ...
          <li class="nav-item">
            <a href="ListaDeClientes" class="nav-link">
            <i class="fas fa-receipt"></i>
              <p>
              Lista de Clientes
...
?>>
          <li class="nav-header" style="font-size: medium; font-weight: bold; color: white;">Créditos <i class="fas fa-credit-card"></i></li>
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
          ...
          <li class="nav-item">
            <a href="CreditoActivo" class="nav-link">
            <i class="fas fa-dot-circle"></i>
              <p>
              Historial abonos
...
?>>
          ...
          <li class="nav-header" style="color: white;">Motivos de consulta</li>
            <li class="nav-item">
                  <a href="https://saludapos.com/AdminPOS/TiposConsultas" class="nav-link" style="color: white;">                    <i class="fas fa-book"></i>
                    <p>
...
<!-- <li class="nav-item has-treeview">
        ...
        Reporte de inventarios
          ...
          <li class="nav-item has-treeview">
            <a href="LotesYFechasCaducidadesGeneral" class="nav-link">
...
?>>
         ...
         Incidencia / Reportes
          ...
          <li class="nav-item">
             ...
             <li class="nav-item">
                  <a href="https://saludapos.com/AdminPOS/TicketsSoporte" class="nav-link" style="color: white;">
