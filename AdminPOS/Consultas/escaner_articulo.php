...
// Obtener la sucursal actual, suponiendo que ya la tienes disponible
$sucursal_actual = $row['Fk_Sucursal'];

// Consultar la base de datos para obtener el artículo correspondiente al código de barras y a la sucursal actual
...
$stmt->bind_param("ss", $codigo, $sucursal_actual);
$stmt->execute();
