...
$data[$c]["Reimpresion"] = '
<td>
<a data-id="' . $fila["Folio_Ticket"] . '-' . $fila["FolioSucursal"] . '" class="btn btn-primary btn-xs btn-Reimpresion dropdown-item" style="background-color: #C80096 !important; padding: 2px 5px; font-size: 12px;"><i class="fas fa-print"></i> Reimprimir</a>
</td>';

$data[$c]["EditarData"] = '
<td>
<a data-id="' . $fila["Folio_Ticket"] . '-' . $fila["FolioSucursal"] . '" class="btn btn-primary btn-xs btn-EditarData dropdown-item" style="background-color: #C80096 !important; padding: 2px 5px; font-size: 12px;"><i class="fas fa-edit"></i> Editar</a>
</td>';
    $c++; 
