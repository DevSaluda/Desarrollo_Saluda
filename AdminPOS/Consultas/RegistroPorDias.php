...
Signos_VitalesV2.Fecha_Estatus,
...
TIMESTAMPDIFF(YEAR, Data_Pacientes.Fecha_Nacimiento, CURDATE()) AS Edad
FROM 
Signos_VitalesV2,
SucursalesCorre,
Data_Pacientes 
WHERE 
DATE(Signos_VitalesV2.Fecha_Visita) = DATE_FORMAT(CURDATE(),'%Y-%m-%d')
AND Signos_VitalesV2.Fk_Sucursal = SucursalesCorre.ID_SucursalC 
AND Data_Pacientes.ID_Data_Paciente = Signos_VitalesV2.Folio_Paciente 
GROUP BY 
Signos_VitalesV2.ID_SignoV;
";  
