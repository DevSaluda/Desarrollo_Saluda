...
$Total_Factura=$conn -> real_escape_string(htmlentities(strip_tags(Trim($_POST['TotalDeFacturaPorGuardar']))));
    $sql = "INSERT INTO `Stock_registrosNuevos`( `ID_Prod_POS`, `Fk_sucursal`, `Existencias_R`, `ExistenciaPrev`, `Recibido`,`AgregadoPor`,`ID_H_O_D`,`Factura`,`Precio_compra`, `Total_Factura`) VALUES
     ('$ID_Prod_POS', '$Fk_sucursal', '$Existencias_R', '$ExistenciaPrev', '$Recibido', '$AgregadoPor','$ID_H_O_D','$Factura','$Precio_compra','$Total_Factura')";
