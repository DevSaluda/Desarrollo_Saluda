...
$encabezados = ["Codigo de Barras", "Nombre del Producto", "Folio de Ticket", "Sucursal", "Turno", "Cantidad", "Total Venta", "Importe", "Descuento", "Forma de Pago", "Cliente", "Folio Signo Vital", "Servicio", "Fecha de venta", "Fecha y hora", "Vendedor", "Enfermero", "Doctor", "Precio Compra", "Precio Venta"];
