...
if (!empty($_POST['name']) || !empty($_FILES['file']['name'])) {
    ...
    $sql = "SELECT Nombre_Apellidos,Fk_Usuario,Correo_Electronico,ID_H_O_D,Fk_Sucursal FROM  Personal_Enfermeria WHERE Nombre_Apellidos='$Nombre_Apellidos' AND ID_H_O_D='$ID_H_O_D' AND Fk_Usuario='$Fk_Usuario'AND Correo_Electronico='$Correo_Electronico' AND Fk_Sucursal='$Fk_Sucursal'";
