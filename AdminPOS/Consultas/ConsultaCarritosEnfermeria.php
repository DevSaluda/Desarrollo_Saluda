                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="dropdown-menu">
                                <a data-id="<?php echo $row["ID_CARRITO"]; ?>" class="btn-editCarrito dropdown-item">Editar datos <i class="fas fa-pencil-alt"></i></a>
                                <a data-id="<?php echo $row["ID_CARRITO"]; ?>" class="btn-detailsCarrito dropdown-item">Detalles <i class="fas fa-info-circle"></i></a>
                                <a data-id="<?php echo $row["ID_CARRITO"]; ?>" class="btn-historialCarrito dropdown-item">Movimientos <i class="fas fa-history"></i></a>
                            </div>
                        </td>
                    </tr>
                <?php endwhile; ?>
