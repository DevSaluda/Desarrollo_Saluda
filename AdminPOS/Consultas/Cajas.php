...
DATE_FORMAT(CONVERT_TZ(Cajas_POS.Hora_real_apertura, '+00:00', '-06:00'), '%h:%i %p') AS Hora_real_apertura_formatted,
DATE_FORMAT(CONVERT_TZ(Cajas_POS.Hora_apertura, '+00:00', '-06:00'), '%h:%i %p') AS Hora_apertura_formatted,
Cajas_POS.Turno,
...
<tr>
<td> <?php echo $Usuarios["ID_Caja"]; ?></td>
...
<?php endif;?>
  ...
  <script>
    ...
    $(".btn-Detalles").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludapos.com/AdminPOS/Modales/DetallesCaja.php","id="+id,function(data){
              $("#FormCajas").html(data);
