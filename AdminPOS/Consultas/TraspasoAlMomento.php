<?php
		...
		Proveedor1, Proveedor2,ProveedorFijo,Estatus,AgregadoPor, ID_H_O_D,TotaldePiezas,TipoMov) VALUES ";
		$queryValue = "";
		for($i=0;$i<$contador;$i++) {
			if(!empty($_POST["Idprod"][$i]) || !empty($_POST["CodBarra"][$i]) || !empty($_POST["NombreProducto"][$i])) {
				...
				'" . $_POST["Existencia1"][$i] . "','" . $_POST["NTraspasos"][$i] . "','" . $_POST["Existencia2"][$i] . "','" . $_POST["FechaAprox"][$i] . "','" . $_POST["GeneradoPor"][$i] . "','" . $_POST["Recibio"][$i] . "','" . $_POST["TipodeServicio"][$i] . "','" . $_POST["Proveedor1"][$i] . "','" . $_POST["Proveedor2"][$i] . "','" . $_POST["ProveedorDelTraspaso"][$i] . "','" . $_POST["Estatus"][$i] . "','" . $_POST["GeneradoPor"][$i] . "','" . $_POST["Empresa"][$i] . "','" . $_POST["resultadepiezas"][$i] . "','" . $_POST["TipoMov"][$i] . "')";
			}
		} 
