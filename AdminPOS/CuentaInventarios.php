                        ...
                        <table class="table table-striped" id="tablaAgregarArticulos" class="display">
                          <thead>
                            <tr>
                              ...
                              <th  class="no-click" style="width:10%">Comentario</th>
                              <!-- <th>Precio compra</th>
                              <th>Importe</th> -->
  ...
  if (row.length) {
    ...
    let tr = `
      <tr data-id="${articulo.id}">
        ...
        <td class="Diferenciaresultante"><input class="form-control cantidad-diferencia-input" style="font-size: 0.75rem readonly !important;" type="number" name="Diferencia[]" /></td>
