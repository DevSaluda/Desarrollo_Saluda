...
<div class="form-group">
  ...
  <input type="text" class="form-control " disabled readonly value="<?php echo $Especialistas->Pprod_ID; ?>">
    </div>
    </div>
  ...
  <input type="text" class="form-control "  readonly value="<?php echo $Especialistas->Nom_Presentacion; ?>" aria-describedby="basic-addon1" maxlength="60">            
</div></div></div>
...
<div class="table-responsive">
  ...
  <tbody>
    <tr>
<td>
<button id="VigenciaBDPre" class="btn btn-default btn-sm" style=<?php echo $Especialistas->Cod_Estado; ?>><?php echo $Especialistas->Estado; ?></button> 
   </td>
    </tr>
