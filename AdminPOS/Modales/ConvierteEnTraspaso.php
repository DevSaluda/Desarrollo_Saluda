                ...
                <tbody>
                    ...
                    while ($Devolucion = $query->fetch_array()): ?>
                        <tr>
                            ...
                            <td><?php echo $Devolucion["Motivo_Devolucion"]; ?><input hidden type="text" value="<?php echo $Devolucion["Precio_Venta"]; ?>"class="form-control"  id="Precioventa" name="PrecioVenta" readonly></td>
