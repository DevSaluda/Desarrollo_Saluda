  ...
  <div class="row">
    <div class="col"> 
      ...
      <i class="fas fa-id-card-alt"></i> <br>
        <?php echo $Especialidades->Nombre_Apellidos; ?>  </div>
    ...
    <i class="fab fa-whatsapp"></i> <br>
      <a href="https://api.whatsapp.com/send/?phone=%2B52<? echo $Especialidades->Telefono; ?>"> <?php echo $Especialidades->Telefono; ?> </a>  </div>
    <div class="col"> <label for="exampleFormControlInput1">Correo</label> <br>
    <i class="fas fa-envelope-square"></i> <br>
      <a href="mailto:<?php echo $Especialidades->Correo_Electronico; ?>"> <?php echo $Especialidades->Correo_Electronico; ?></a>  </div>
