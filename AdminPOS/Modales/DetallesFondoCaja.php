...
FROM Fondos_Cajas, SucursalesCorre 
WHERE Fondos_Cajas.Fk_Sucursal = SucursalesCorre.ID_SucursalC 
AND Fondos_Cajas.ID_H_O_D = '" . $row['ID_H_O_D'] . "' 
AND Fondos_Cajas.ID_Fon_Caja = " . $_POST["id"];
