...
FROM Fondos_Cajas_Audita, SucursalesCorre 
WHERE Fondos_Cajas_Audita.Fk_Sucursal = SucursalesCorre.ID_SucursalC 
AND Fondos_Cajas_Audita.ID_H_O_D = '".$row['ID_H_O_D']."' 
AND Fondos_Cajas_Audita.ID_Fon_Caja = ".$_POST["id"];
