      ...
      <div class="text-center">
        ...
        <div class="modal-body">
          <form action="javascript:void(0)" method="post" id="AgregaTipoConsultaNueva">
            ...
            <div><label for="nombretipoconsulta" class="error"></label></div>
            ...
            <input type="text" class="form-control" hidden readonly id="usuario" name="UsuarioTipoConsulta" value="<?echo $row['Nombre_Apellidos']?>">
            <input type="text" class="form-control" hidden readonly name="VigenciaTipoConsulta" id="vigenciaestTipoConsulta">
            <input type="text" class="form-control" hidden readonly id="sistema" name="SistemaTipoConsulta" value="POS <?echo $row['Nombre_rol']?>">
            <input type="text" class="form-control" hidden readonly id="empresa" name="EmpresaTipoConsulta" value="<?echo $row['ID_H_O_D']?>">
            <div>
