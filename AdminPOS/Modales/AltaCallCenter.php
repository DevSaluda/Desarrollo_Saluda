...
$ColorEstatus=  $conn -> real_escape_string(htmlentities(strip_tags(Trim($_POST['vigencia']))));
    ...
    $row = mysqli_fetch_assoc($resultset);  
        ...
        {       
            ...
            $sql = "INSERT INTO `Personal_Agenda`(`PersonalAgenda_ID`,`Nombre_Apellidos`,`Password`,`file_name`,`Fk_Usuario`,`Fecha_Nacimiento`,`Correo_Electronico`,`Telefono`,`AgregadoPor`,`ID_H_O_D`,`Estatus`,`ColorEstatus`) 
 VALUES ('$PersonalAgenda_ID','$Nombre_Apellidos','$Password','$uploadedFile','$Fk_Usuario','$Fecha_Nacimiento','$Correo_Electronico','$Telefono','$AgregadoPor','$ID_H_O_D','$Estatus','$ColorEstatus')";
