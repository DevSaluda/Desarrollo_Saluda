...
<div class="card text-center">
 ...
 Lotes y fechas de caducidades disponibles de  <?php echo $row['ID_H_O_D']?> al <?php echo FechaCastellano(date('d-m-Y H:i:s')); ?>  
  </div>
...
<!-- REQUIRED SCRIPTS -->
<script src="js/LotesYFechasGeneral.js"></script>
