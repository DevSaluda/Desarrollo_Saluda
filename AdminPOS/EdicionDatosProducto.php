...
<div class="col">
  ...
  <input type="number" class="form-control " onchange="validarPrecioVenta()" id="acaspv" name="ACASPV" value="<? echo $Especialistas->Precio_Venta; ?>" >
</div><label for="pv" class="error"></div>
<div class="col">
  ...
  <input type="number" class="form-control "   onchange="actualizarPrecioCompra() "  id="pcc" name="pcc"value="<? echo $Especialistas->Precio_C; ?>" >
    </div><label for="pc" class="error">
    </div>
    <div class="col">
