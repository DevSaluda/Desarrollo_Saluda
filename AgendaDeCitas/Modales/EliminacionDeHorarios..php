...
<?php if ($Especialistas != null): ?>
    ...
    <div id="content" style="display: none;">
        <form action="javascript:void(0)" method="post" id="EliminarHoras">
            <div class="modal-body">
                <p>¿Está seguro de eliminar las horas seleccionadas para el médico <?php echo $Especialistas->Nombre_Apellidos; ?> de la sucursal <?php echo $Especialistas->Nombre_Sucursal; ?> durante el periodo <?php echo $Especialistas->Fecha_Inicio; ?> al <?php echo $Especialistas->Fecha_Fin; ?>? <br>
            ...
            <input type="text" class="form-control" hidden name="HorasEliminar[]" id="HorasEliminar" readonly />

            <div class="modal-footer justify-content-center">
                <button type="submit" id="EnviarDatos" value="Eliminar" class="btn btn-danger">Eliminar <i class="fas fa-trash"></i></button>
                <button type="button" id="CancelarEliminar" class="btn btn-secondary">Cancelar <i class="fas fa-times"></i></button>
            </div>
        </form>
    </div>
