...
// La notificación no contiene información del evento directamente
// Ejecutamos la sincronización al recibir cualquier notificación
...
function syncWithGoogleCalendar($conn) {
    ...
    // Obtener los GoogleEventId de la base de datos
    $sql = "SELECT GoogleEventId FROM AgendaCitas_EspecialistasExt";
