$('document').ready(function($){
    ...
    $("#EliminaFechasDemedicosEspecialistas").validate({
        rules: {
    ...
    function submitForm() {		
        ...
        var formData = $('#EliminaFechasDemedicosEspecialistas').serializeArray();
        var checkboxesEliminar = $('.checkboxEliminar:checked');

        checkboxesEliminar.each(function() {
        ...
        $.ajax({				
            type : 'POST',
            url: "Consultas/postEliminaFechasEspecialidades.php",
            data: formData,
            cache: false,
            beforeSend: function(){	
                $("#success").fadeOut();
