            ...
            $.ajax({
                ...
                success: function(dataResult) {
                    ...
                    if (result.statusCode === 200) {
                        ...
                        $("#RegistroTicketSoporteModal").modal('hide'); // Cierra el modal de registro
                        $('#Exito').modal('toggle'); // Muestra el modal de éxito
                        setTimeout(function() {
                            $('#Exito').modal('hide'); // Cierra el modal de éxito después de 2 segundos
                        }, 2000);
                    } else {
                        $("#submitTicketSoporte").html("Algo no salió bien... <i class='fas fa-exclamation-triangle'></i>");
                        $('#ErrorData').modal('toggle'); // Muestra el modal de error
                        setTimeout(function() {
