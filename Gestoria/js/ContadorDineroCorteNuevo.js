 function multiplicar() {
     ...
     document.getElementById("resultadototalventas").value = total
     document.getElementById("resultadototalventasTicket").value = total
