...
<?php endif;?>
  ...
  <script>
    ...
    $(".btn-Detalles").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludapos.com/POS2/Modales/DetallesCitaSucursal.php","id="+id,function(data){
              $("#form-edit").html(data);
    ...
    $(".btn-Cancela").click(function(){
  		id = $(this).data("id");
  		$.post("https://saludapos.com/POS2/Modales/CancelaCita.php","id="+id,function(data){
              $("#form-edit").html(data);
