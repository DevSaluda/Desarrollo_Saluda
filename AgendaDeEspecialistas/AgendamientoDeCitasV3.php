...
<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#CitasPorFechasBusqueda" style="background-color: #C80096 !important;" class="btn btn-default">
